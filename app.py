...
if submitted:
    ...
    st.markdown("""
    - **감수성 Sensitivity**: '왜?' 질문 5번 던지기. 귀차니즘을 벗어나기. 문제의식 호기심 갖기  
    - **재정의 Reidentification**: 여러가지 관점으로 보려고 노력하기  
    - **독창성 Originality**: 남과 다르려고 노력하기  
    - **유연성 Flexibility**: 고집을 내려놓기.엉뚱한 것도 받아드리기. 듣기연습  
    - **유창성 Fluency**: 쉬지않고 생각하기. 5분 동안 아이디어 30개 적기 등,  
    - **정교성/집중 Elaboration**: 끈기를 갖고 노력하고 집중하기.  
    """)
